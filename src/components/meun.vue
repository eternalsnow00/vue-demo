<template>
  <div>
    ...
    <div class="meun">
      <div class="meunlist">
        <router-link to="/create" class="tab"><img src="../assets/icon1.png" width="40px"/>新建会议</router-link>
      </div>
      <div class="meunlist2">
      ...
      <div class="meunlist">
        <router-link to="/pdf" class="tab"><img src="../assets/icon4.png" width="40px"/>用户手册</router-link>
      </div>
    </div>
  </div>
</template>
